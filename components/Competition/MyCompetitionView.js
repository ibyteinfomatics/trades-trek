            ...
            <div className='myConn'>
                <div className='connectionBlock'>
                    <div className='titleBox px-32 py-16'>
                        <h4 className='font-18 font--bold mb-12'>TradesTrek Trading Game</h4>
                    </div>
                            ...
                            <div className='colRightBlock'>
                                <div className='flexBox endBlock'>
                                    <div className='colBlock'>
                                        ...
                                        <h2 className='font-17 font--bold'>March 29, 2021 - No End</h2>
                                    </div>
                                    <div className='colBlock'>
                                        <p className='font-17 font--normal'>CURRENT RANK</p>
                                        <h2 className='font-17 font--bold flexBox'>266,745
                                            <span className='font-17 font--normal flexBox'>
                                                <svg className="ml-12 mr-12" width="13" height="14" viewBox="0 0 18 18" fill="none"><path d="M9 0.445312L8.46094 0.960937L0.960938 8.46094L2.03906 9.53906L8.25 3.32812V18H9.75V3.32812L15.9609 9.53906L17.0391 8.46094L9.53906 0.960937L9 0.445312Z" fill="#00FFA0"></path></svg>
                                                of 364,664 Players
                                            </span>
                                        </h2>
                                    </div>
                                    ...
                                    <h5 className='font-16 text--purple'>
                                        ...
                                        <span>
                                            <svg width="7" height="12" viewBox="0 0 8 13" fill="none">
                                                <path d="M0.734375 0.0234375L0.015625 0.726562L5.67578 6.5L0.015625 12.2773L0.734375 12.9727L7.07422 6.5L0.734375 0.0234375Z" fill="#8000FF" />
                                            </svg>
                                        </span>
                                    </h5>
                                </div>
                                    ...
                                    <h5 className='font-16 text--purple mt-32'>
                                        ...
                                        <span>
                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                                                <path d="M6 0C2.69187 0 0 2.69187 0 6C0 9.30813 2.69187 12 6 12C9.30813 12 12 9.30813 12 6H11C11 8.76787 8.76787 11 6 11C3.23213 11 1 8.76787 1 6C1 3.23213 3.23213 1 6 1C7.51111 1 8.85378 1.675 9.76953 2.73047L8.5 4H12V0.5L10.4766 2.02344C9.37687 0.786984 7.78113 0 6 0Z" fill="#8000FF" />
                                            </svg>
                                        </span>
                                    </h5>
                                </div>
