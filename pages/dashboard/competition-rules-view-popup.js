...
export default function CompetationRulesViewPopup() {
    return (
        <>
                ...
                <div className='boxAlign'>
                    ...
                    <div className='popupBody'>
                        <div className='popupTop'>
                            <h4 className='font-16 font--bold mb-16 mt-16'>TradesTrek Trading Game</h4>
                            <div className='rowBlock'>
                                <div className='textBlock'>
                                    <p className='textTitle'>TIMING</p>
                                    <p className='textTitle bold'>March 29, 2021 - No End</p>
                                </div>
                            </div>
                            <div className='rowBlock'>
                                <div className='textBlock'>
                                    <p className='textTitle'>NO OF PLAYERS</p>
                                    <p className='textTitle bold'>266,745</p>
                                </div>
                            </div>
                            <div className='rowBlock'>
                                <div className='textBlock'>
                                    <p className='textTitle'>STARTING CASH</p>
                                    <p className='textTitle bold'>₦100,000.00</p>
                                </div>
                            </div>
                        </div>
